...
import * as useDraggableBasic from "./useDraggableBasic.stories";

<Meta of={useDraggableBasic} title="Basic useDraggable Demo" />
...
<Canvas of={useDraggableBasic.UseDraggableBasicExample} />

# basic useDraggable custom hook on an SVG component

A slightly fancier example, using an SVG with a draggable circle

<Canvas of={useDraggableBasic.UseDraggableSVGDemo} />
