...
const meta: Meta<BasicComponent> = {
  title: "useWheelAdjust example"
};

export default meta;

export const UseWheelAdjustExample: StoryObj<BasicComponent> = {
  render: () => {
    const containerRef = useRef<HTMLDivElement>(null);
    const [value, setValue] = useState(0);

    const { wheelDelta, isScrolling } = useWheelAdjust({ containerRef, sensitivity: 2 });
