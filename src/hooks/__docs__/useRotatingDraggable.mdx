...
`useRotatingDraggable` gives you basic functionality: it lets you drag an element around an origin, and it will
...
It uses `useDraggable` under the hood to track when the user is dragging the target, and `useWheelSpeed` to
