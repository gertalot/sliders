//useDraggable/__test__/useDraggable.test.tsx
...
describe("useDraggable hook", () => {
  const DemoComponent = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center bg-gray-900  text-white p-4 touch-none">
  ...
  it("Button should render correctly", () => {
    ...
    const button = screen.getByRole("circle");
